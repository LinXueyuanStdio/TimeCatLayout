...
public class MiniVerticalActionView extends LinearLayout {
    ...
    public MiniVerticalActionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflate(context, R.layout.miniactionview_vertical, this);
    ...
    public void onEditMode() {
        iv_full_edit.setVisibility(View.VISIBLE);
        iv_copy.setVisibility(View.GONE);
        iv_nlp.setVisibility(View.GONE);
        iv_translate.setVisibility(View.GONE);
        iv_search.setVisibility(View.GONE);
        iv_share.setVisibility(View.GONE);
        iv_attachment.setVisibility(View.VISIBLE);
        iv_reminder.setVisibility(View.VISIBLE);
        iv_labels.setVisibility(View.GONE);
        iv_checklist.setVisibility(View.VISIBLE);
    ...
    public void onViewMode() {
        ...
        iv_nlp.setVisibility(View.VISIBLE);
        iv_translate.setVisibility(View.VISIBLE);
        iv_search.setVisibility(View.VISIBLE);
        iv_share.setVisibility(View.VISIBLE);
        iv_attachment.setVisibility(View.VISIBLE);
        iv_reminder.setVisibility(View.VISIBLE);
        iv_labels.setVisibility(View.VISIBLE);
        iv_checklist.setVisibility(View.GONE);
        iv_more.setVisibility(View.VISIBLE);
    }


    public void onEditTaskMode() {
        iv_full_edit.setVisibility(View.GONE);
        iv_copy.setVisibility(View.VISIBLE);
        iv_nlp.setVisibility(View.VISIBLE);
        iv_translate.setVisibility(View.VISIBLE);
        iv_search.setVisibility(View.VISIBLE);
    ...
    public void onEditNoteMode() {
        ...
        iv_share.setVisibility(View.GONE);
        iv_attachment.setVisibility(View.GONE);
        iv_reminder.setVisibility(View.GONE);
        iv_labels.setVisibility(View.VISIBLE);
        iv_checklist.setVisibility(View.GONE);
        iv_more.setVisibility(View.VISIBLE);
    }

    public void onEditHabitMode() {
        iv_full_edit.setVisibility(View.GONE);
        iv_copy.setVisibility(View.VISIBLE);
        iv_nlp.setVisibility(View.VISIBLE);
        iv_translate.setVisibility(View.VISIBLE);
    ...
    public void setMarginTop(int marginTop) {
        LinearLayout.LayoutParams l = (LayoutParams) iv_full_edit.getLayoutParams();
        l.topMargin = ViewUtil.dp2px(marginTop);
    }

    public void setMarginBottom(int marginTop) {
        LinearLayout.LayoutParams l = (LayoutParams) iv_share.getLayoutParams();
        l.bottomMargin = ViewUtil.dp2px(marginTop);
    }
    ...
    public void setMiniAction(@NonNull MiniAction miniAction, Position tooltipPosition) {
        ...
        iv_full_edit.setOnLongClickListener(v -> showToolTip(v, "用编辑器打开", tooltipPosition));
        iv_copy.setOnLongClickListener(v -> showToolTip(v, "复制", tooltipPosition));
        iv_nlp.setOnLongClickListener(v -> showToolTip(v, "自然语言处理（分词）", tooltipPosition));
        iv_translate.setOnLongClickListener(v -> showToolTip(v, "翻译", tooltipPosition));
        iv_search.setOnLongClickListener(v -> showToolTip(v, "搜索", tooltipPosition));
        iv_share.setOnLongClickListener(v -> showToolTip(v, "分享", tooltipPosition));
        iv_attachment.setOnLongClickListener(v -> showToolTip(v, "附件", tooltipPosition));
        iv_reminder.setOnLongClickListener(v -> showToolTip(v, "提醒", tooltipPosition));
        iv_labels.setOnLongClickListener(v -> showToolTip(v, "标签", tooltipPosition));
        iv_checklist.setOnLongClickListener(v -> showToolTip(v, "清单/Markdown", tooltipPosition));
        iv_more.setOnLongClickListener(v -> showToolTip(v, "更多", tooltipPosition));
    }
