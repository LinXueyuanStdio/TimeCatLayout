package com.timecat.layout.ui.business.ninegrid;
...
public class NineGirdImageContainer extends FrameLayout {
    ...
    private int mIcDelete = R.drawable.ic_delete_24dp;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mIsDeleteMode) {
            ...
            int size = ViewUtil.dp2px(getContext(), 16);
    ...
    public void showGifIcon() {
        ...
        int margin = ViewUtil.dp2px(getContext(), 8);
    ...
    public void setIsDeleteMode(boolean b) {
        ...
        if (mIsDeleteMode) {
            if (mImgDelete == null) {
                ...
                int size = ViewUtil.dp2px(getContext(), 24);
