...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (attr == R.styleable.RoundProgressBar_outer_layer_slide_color) {
                outLayerSlideColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_outer_layer_stroke_color) {
                outLayerStrokeColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_outer_layer_stroke_width) {
                outLayerStrokeWidth = typedArray.getDimensionPixelOffset(attr, 0);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_progress_color) {
                middleLayerProgressColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_progress_width) {
                middleLayerProgressWidth = typedArray.getDimensionPixelOffset(attr, 0);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_bg_color) {
                middleLayerBgColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_small_circle_slide_color) {
                smallCircleSlideColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_small_circle_stroke_color) {
                smallCircleStrokeColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_small_circle_size) {
                smallCircleSize = typedArray.getDimensionPixelSize(attr, 0);

            } else if (attr == R.styleable.RoundProgressBar_middle_layer_small_circle_stroke_width) {
                smallCircleStrokeWidth = typedArray.getDimensionPixelOffset(attr, 0);

            } else if (attr == R.styleable.RoundProgressBar_shadow_layer_color) {
                shadowLayerColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_shadow_layer_inner_color) {
                shadowLayerInnerColor = typedArray.getColor(attr, Color.BLACK);

            } else if (attr == R.styleable.RoundProgressBar_inner_text_size) {
                innerTextSize = typedArray.getDimensionPixelSize(attr, 0);

            } else if (attr == R.styleable.RoundProgressBar_inner_text_color) {
