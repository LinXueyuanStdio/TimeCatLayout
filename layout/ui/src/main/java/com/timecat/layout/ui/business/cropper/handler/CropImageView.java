...
package com.timecat.layout.ui.business.cropper.handler;
...
public class CropImageView extends FrameLayout {
    ...
    public void setImageUriAsync(Uri uri) {
        if (uri != null) {
            ...
            // either no existing habit is working or we canceled it, need to load new URI
            clearImageInt();
            mCropOverlayView.setInitialCropWindowRect(null);
    ...
    public enum ScaleType {
         ...
         * dimensions (width and height) of the image will be equal to or <dp2px>larger</dp2px> than the
        ...
        /**
         * Scale the image uniformly (maintain the image's aspect ratio) so that both
         * dimensions (width and height) of the image will be equal to or <dp2px>less</dp2px> than the
         * corresponding dimension of the view (minus padding).<br>
