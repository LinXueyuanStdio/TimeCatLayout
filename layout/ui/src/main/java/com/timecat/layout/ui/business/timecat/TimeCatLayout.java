...
public class TimeCatLayout extends ViewGroup implements TimeCatHeader.ActionListener, NestedScrollingChild {
    ...
    private static final int DEFAULT_TEXT_COLOR_RES = R.drawable.timecat_item_text;
    ...
    boolean autoAddBlanks = DEF.config().getBoolean(Constants.AUTO_ADD_BLANKS, false);
    ...
    public TimeCatLayout(Context context) {
        super(context);
    }


    public TimeCatLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public TimeCatLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TimeCatLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.TimeCatLayout);
            mItemSpace = typedArray.getDimensionPixelSize(R.styleable.TimeCatLayout_timecat_itemSpace, getResources().getDimensionPixelSize(R.dimen.big_bang_default_item_space));
            mLineSpace = typedArray.getDimensionPixelSize(R.styleable.TimeCatLayout_timecat_lineSpace, getResources().getDimensionPixelSize(R.dimen.big_bang_default_line_space));

            mTextColorRes = typedArray.getResourceId(R.styleable.TimeCatLayout_timecat_textColor, DEFAULT_TEXT_COLOR_RES);
            mTextSize = (int) ViewUtil.px2sp(typedArray.getDimension(R.styleable.TimeCatLayout_timecat_textSize, ViewUtil.sp2px(DEFAULT_TEXT_SIZE)));
            mTextBgRes = typedArray.getResourceId(R.styleable.TimeCatLayout_timecat_textBackground, DEFAULT_TEXT_BG_RES);
            mSectionTextBgRes = typedArray.getResourceId(R.styleable.TimeCatLayout_timecat_sectionTextBackground, DEFAULT_SECTION_TEXT_BG_RES);
            typedArray.recycle();
        ...
        // TODO 暂时放到这里
        mHeader = new TimeCatHeader(getContext());
        mHeader.setVisibility(View.GONE);
...
//                    dragItem = null;
    ...
    public void setBackgroundColorAlpha(int value) {
        ...
        setBackgroundColor(Color.argb(value, 0, 0, 0));
    }
