...
public class TimeCatBottom extends ViewGroup implements View.OnClickListener {
    ...
    public TimeCatBottom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeCatBottom(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initSubViews();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TimeCatBottom(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setIsLocal(boolean isLocal) {
        ...
        if (isLocal) {
            mType.setImageResource(R.mipmap.timecat_action_local);
    ...
    public void setShowSymbol(boolean showSymbol) {
        ...
        if (showSymbol) {
            ...
            mSymbol.setImageResource(R.mipmap.timecat_action_no_symbol);
    ...
    public void setShowSection(boolean showSection) {
        ...
        if (showSection) {
            ...
            mSection.setImageResource(R.mipmap.timecat_action_no_enter);
